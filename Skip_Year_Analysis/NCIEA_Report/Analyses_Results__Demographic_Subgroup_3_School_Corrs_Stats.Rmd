...
###   Calculate School Level Demographic Group Summaries
	...
	tmp.caption <- paste("School level correlations between mean SGPs and percent",  demog.group$label, "by student inclusion filter")
	knitr::knit_print(htmlTable::htmlTable(as.matrix(cor_tbl_demog), title="",
	  align=paste(rep("r", ncol(cor_tbl_demog)), collapse=""),
