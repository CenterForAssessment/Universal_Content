...
```{r, results='asis', echo=FALSE}
	...
	tmp.caption <- paste("Sequential and skip-year SGP counts and percentages by content area and",  demog.group$label, "status")
	knitr::knit_print(htmlTable::htmlTable(as.matrix(demog_counts), title="", 
	  align=paste(rep("r", ncol(demog_counts)), collapse=""),
		n.rgroup = rep(2, nrow(demog_counts)/2), rnames=FALSE,
