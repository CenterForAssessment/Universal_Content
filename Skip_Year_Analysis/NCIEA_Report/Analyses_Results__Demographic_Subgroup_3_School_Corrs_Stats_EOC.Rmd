...
###   Calculate School Level Demographic Group Summaries - EOC Subjects
	...
	tmp.caption <- paste("School level EOC subject correlations between mean SGPs and percent",  demog.group$label)
	knitr::knit_print(htmlTable::htmlTable(as.matrix(cor_tbl_demog_eoc), title="",
