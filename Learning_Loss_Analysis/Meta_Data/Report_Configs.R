...
report.config <- list(
  top.level=list(             # Title/subtitle, author.names, author.affil, date
    ...
    author.names = c("Damian W. Betebenner, Adam R. VanIwaarden,<br><br>Nathan Dadey and Michelle Boyer"),
    # author.affil = "Center for Assessment", # Only needed if different affiliations. - Could also just be single "Center for Assessment"
