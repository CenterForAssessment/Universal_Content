...
```{r, echo=FALSE, include=FALSE}
  ...
  options(table_num_str = "G%d") # Prepend Appendix Letter when using tblNum()
  options(table_counter_str = paste0("**Table ", "G", "%s:**")) # "**Table A%s:**" LETTERS[appendix.number]
  options(fig_num_str = "G%d") # Prepend Appendix Letter when using figNum()
  options(fig_caption_no_sprintf = paste0("**Figure ", "G", "%d:** %s")) # "**Figure A%d:** %s"
