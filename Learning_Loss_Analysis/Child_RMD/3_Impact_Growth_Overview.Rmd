...
# results='asis',
	...
	tmp.caption <- "Median baseline and cohort SGPs by year, content area and grade"
...
```{r, example-table-2, fig.cap="Median baseline and cohort SGPs by year, content area and grade", out.width="0", out.height="0", out.extra=tab.out.ex, class = "figtab", results="asis"}
